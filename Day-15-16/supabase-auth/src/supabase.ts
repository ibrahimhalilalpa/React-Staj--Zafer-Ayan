...
// // Create a single supabase client for interacting with your database
// export const supabase = createClient(
//   "https://xflmapomogdvbsymjnyc.supabase.co",
//   "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhmbG1hcG9tb2dkdmJzeW1qbnljIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTU3MTU0NzQsImV4cCI6MjA3MTI5MTQ3NH0.O9hqu363aElf-Mnwb0FFFjbRB7SFYAJmvXOPdOyGAmU"
// );